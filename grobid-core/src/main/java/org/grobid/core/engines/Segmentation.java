...
public class Segmentation extends AbstractParser {
	...
	*/
	 ...
	 */
	public static String getAllLinesFeatured(List<Block> blocks, List<String> tokenizations) {
		FeatureFactory featureFactory = FeatureFactory.getInstance();
        StringBuilder fulltext = new StringBuilder();
        String currentFont = null;
        int currentFontSize = -1;
    ...
    public void createTrainingSegmentation(String inputFile,
        ...
        try {
            ...
            String fulltext = getAllLinesFeatured(doc.getBlocks(), doc.getTokenizations());
